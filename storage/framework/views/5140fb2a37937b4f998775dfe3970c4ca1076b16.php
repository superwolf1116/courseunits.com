    ...
    <div class="container">
        ...
        <div class="courses-main-bx">
            <ul class="nav courses-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="<?php echo e($key); ?>-tab" data-toggle="tab" href="#tab<?php echo e($key); ?>" role="tab" aria-controls="profile" aria-selected="false"><?php echo e(ucfirst($category)); ?></a>
                </li>
            ...
            <div class="tab-content" id="myTabContent">
                    ...
                    <div class="courses-tab-bx">
                        <div class="row">
                            <?php if($courseslist): ?>
                            <?php $__currentLoopData = $courseslist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $courses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allrecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if($categorylist): ?>
                <?php $__currentLoopData = $categorylist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="tab-pane fade" id="tab<?php echo e($key); ?>" role="tabpanel" aria-labelledby="<?php echo e($key); ?>-tab">
                    <div class="courses-tab-bx">
                        <div class="row">
                            <?php if(isset($courseslist[$key])): ?>
                            <?php $__currentLoopData = $courseslist[$key]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allrecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-xs-12 col-md-6 col-lg-3" data-aos="fade-right">
                                <div class="card">
                                    <div class="card-img">
                                        <?php
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6 col-lg-6"> 
                    <div class="personal-step-img"> 
                        <?php echo e(HTML::image('public/img/front/personal-step.png', SITE_TITLE)); ?>
                ...
                <div class="col-xs-12 col-md-6 col-lg-6">
                    <div class="personal-step"> 
                        ...
                        <a href="<?php echo e(URL::to('courses')); ?>" class="btn btn-primary">Get Started</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="categories-main-bx">
            ...
            <div class="seemore" data-aos="zoom-in">
                <a href="<?php echo e(URL::to('categories')); ?>"><span>Show More</span><i>
                        <?php echo e(HTML::image('public/img/front/arrow.png', SITE_TITLE)); ?>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6 col-lg-6" data-aos="fade-right"> 
                    <div class="instructor-img"> 
                        <?php echo e(HTML::image('public/img/front/about-me-profile.jpg', SITE_TITLE)); ?>

                    </div>
                    <div class="maxcoach-img"> 
                        <?php echo e(HTML::image('public/img/front/maxcoach.png', SITE_TITLE)); ?>
                ...
                <div class="col-xs-12 col-md-6 col-lg-6" data-aos="fade-left">
                    <div class="instructor-bx"> 
                        ...
                        <a href="<?php echo e(URL::to('teaching')); ?>" class="btn btn-primary">Start teaching today</a>
                    </div>
                </div>
            </div>
        </div>
