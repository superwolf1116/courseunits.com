...
<div class="slider">
                                    ...
                                    <nav class="navbar navbar-expand-lg navbar-light feedart-menu nevication-bar">
                                        ...
                                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                            ...
                                            <a class="nav-link" href="<?php echo e(URL::to('viewcart')); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="crtcnt"><?php echo isset($cartCount) ? $cartCount : 0; ?></span></a></li>
                                                ...
                                                <?php else: ?> 
                                                <li class="nav-item"><a class="nav-link login-text" href='<?php echo e(URL::to('login')); ?>'>My Account</a></li>
    ...
    <div class="ld-banner">
        <div class="container">
            ...
            <p>Study any topic, anytime. Choose from thousands<br> of expert-led courses now.</p>

            <a class="btn btn-primary" href="<?php echo e(URL::to('register')); ?>">Join for free</a></span>
