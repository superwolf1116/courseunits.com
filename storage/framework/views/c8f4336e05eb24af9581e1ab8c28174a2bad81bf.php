                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-5 col-lg-4">
                        <div class="search-bar">
                            ...
                            <input class="required form-control" type="search" name="title" autocomplete="off" placeholder="Search Course" aria-label="Search" value="<?php echo e($olftitle); ?>">
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light feedart-menu nevication-bar">
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    ...
                                    <ul class="navbar-nav ml-auto right-menus">
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('my-courses')); ?>">My Courses</a></li>
                                        <li class="nav-item wishlist_llc"><a class="nav-link" href="<?php echo e(URL::to('wishlist')); ?>"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
                                        ...
                                        <li class="nav-item dropdown notification-b">
                                            <a class="nav-link" href="<?php echo e(URL::to( 'users/notifications')); ?>"><i class="fa fa-bell-o" aria-hidden="true"></i></a>
                                        ...
                                        <li class="nav-item dropdown users-dropdown">
                                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <span class="user-profile-img">
                                                    ...
                                                    <?php if(isset($userHInfo->profile_image) && $userHInfo->profile_image!='' && file_exists(PROFILE_SMALL_UPLOAD_PATH.$userHInfo->profile_image)): ?>
                                                    <?php echo e(HTML::image(PROFILE_SMALL_DISPLAY_PATH.$userHInfo->profile_image, SITE_TITLE, ['id'=> 'pimage'])); ?>

                                                    <?php else: ?>
                                                    <?php echo e(HTML::image('public/img/front/no_profile.png', SITE_TITLE, ['id'=> 'pimage'])); ?>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                <div class="top_scc">
                                                    <a href="<?php echo e(URL::to('users/myaccount')); ?>" class="user-profile-dropdown">
                                                        <span class="user-profile-img">
                                                           <?php if(isset($userHInfo->profile_image) && $userHInfo->profile_image!='' && file_exists(PROFILE_SMALL_UPLOAD_PATH.$userHInfo->profile_image)): ?>
                                                            <?php echo e(HTML::image(PROFILE_SMALL_DISPLAY_PATH.$userHInfo->profile_image, SITE_TITLE, ['id'=> 'pimage'])); ?>
                                                        ...
                                                        <div class="user-dropdown-sub">
                                                            <div style="width: 100%;">
                                                                <div class="heading-md"><?php echo e($userHInfo->first_name.' '.$userHInfo->last_name); ?></div>
                                                                <div class="heading-email"><?php echo e($userHInfo->email_address); ?></div>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
                                                <div class="clear-all"></div>
                                                <a class="dropdown-item" href="<?php echo e(URL::to('my-courses')); ?>">My Courses </a>
                                                <a class="dropdown-item" href="<?php echo e(URL::to('viewcart')); ?>">My Cart </a>
                                                <a class="dropdown-item" href="<?php echo e(URL::to('wishlist')); ?>">Wishlist </a>
                                                <div class="clear-all"></div>
                                                <a class="dropdown-item" href="<?php echo e(URL::to('courses/management')); ?>">Manage Courses </a>
                                                <a class="dropdown-item" href="<?php echo e(URL::to('selling-orders')); ?>">Selling Courses </a>
                                                <a class="dropdown-item" href="<?php echo e(URL::to('purchase-history')); ?>">Purchase History </a>
                                                <div class="clear-all"></div>
                                                <a class="dropdown-item" href="<?php echo e(URL::to('users/myaccount')); ?>">My Account </a>
                                                <a class="dropdown-item" href="<?php echo e(URL::to('users/settings')); ?>">Edit Profile</a>
