...
<div class="detai_page">
    <div class="login-wapper ddreg">        
        <div class="login-bg">  
            <div class="signn">Become <?php echo e(SITE_TITLE); ?> Instructor! </div>
            ...
            <div normal_login>
                ...
                <div class="sign_center">
                    <div class="always_btn">Already Have an Account? <a href="<?php echo e(URL::to( 'teacher-login')); ?>"></i>Login</a></div> 
                </div>
