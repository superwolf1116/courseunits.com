...
<section class="cart-details-section">
    <div class="container container-header">
        ...
        <input name="totalcount" type="hidden" id="totalcount" value="<?php echo e($cartCount); ?>">
        
        <?php if(!$allrecords->isEmpty()): ?>
        <div class="row" id="cours_scc">
            <div class="col-xs-12 col-md-8 col-lg-9">
                <div class="shopping-cart-details">
                    <h2 id="cart_lst"><?php echo e($cartCount); ?> Courses in Cart</h2>
                    ...
                    <div class="cart-details">
                        ...
                        <ul id="cartlist_<?php echo e($allrecord->id); ?>">
                            ...
                            <li class="cart-product-details">
                                <h4><?php echo e($allrecord->Course->title); ?></h4>
                                <p>By <?php echo e($allrecord->Course->User->first_name.' '.$allrecord->Course->User->last_name); ?></p>
                            </li>
                            ...
                            <li class="cart-product-price">
                                <strong><i class="fa fa-dollar" aria-hidden="true"></i> <?php echo e(number_format($allrecord->Course->price,2)); ?> </strong>
                                <span><i class="fa fa-dollar" aria-hidden="true"></i> <?php echo e(number_format($allrecord->Course->price+200,2)); ?></span>
                            </li>
                        </ul>
                        <?php 
            ...
            <div class="col-xs-12 col-md-4 col-lg-3">
                <div class="checkout-price-bx">
                    <h4>Total:</h4>
                    <h2 id="subtotal"><?php echo e(CURR); ?> <?php echo e(number_format(array_sum($subtotal),2)); ?></h2>
                    <span id="total"><?php echo e(CURR); ?> <?php echo e(number_format(array_sum($total),2)); ?></span>
                    <h5 id="perct">
                        <?php 
                        $per = round((100-((array_sum($subtotal)*100)/array_sum($total))));
                        echo $per; ?>% off</h5>
                    <input name="subtotalcost" type="hidden" id="subtotalcost" value="<?php echo e(array_sum($subtotal)); ?>">
        <input name="totalcost" type="hidden" id="totalcost" value="<?php echo e(array_sum($total)); ?>">
        <input name="pertg" type="hidden" id="pertg" value="<?php echo e($per); ?>">
                    <a href="<?php echo e(URL::to( '/checkout')); ?>" class="btn btn-primary">Checkout</a>
        ...
        <div class="row" id="empty_scc" style="display: none;">
            <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="shopping-cart-details">
                    <h2 id="cart_lst1"><?php echo e($cartCount); ?> Courses in Cart</h2>
                    <div class="empty_cart">
                        <i class="fa fa-shopping-cart" aria-hidden="true"></i>
                        <p>Your cart is empty. Keep shopping to find a course!</p>
                        <a class="btn btn-primary" href="<?php echo e(URL::to( '/courses')); ?>">Keep shopping</a>
                    </div>
                </div>
            </div>
        </div>
...
//            data: $('#AddToCartMain' + cid).serialize(),            
            success: function (result) {
                ...
                $('#subtotal').html('<?php echo e(CURR); ?> '+updatesubtotal.toFixed(2));
                $('#totalcost').val(updatetotal);
                $('#total').html('<?php echo e(CURR); ?> '+updatetotal.toFixed(2));
                $('#pertg').val(per);
                $('#perct').html(per+'% off');
