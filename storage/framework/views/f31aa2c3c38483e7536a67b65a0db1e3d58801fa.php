                ...
                <div class="billing-address-bx">
                    ...
                    <div class="billing-address">
                        ...
                        <div class="filter-courses-select">
                            <span>
                                <?php echo e(Form::select('country_id', $countryList,'', ['id'=>'country_id','class' => 'form-control required','placeholder' => 'Select Country'])); ?>
                    ...
                    <div class="billing-address billing-address-right">
                        ...
                        <div class="filter-courses-select" id="selectstate">
                            <span>
                                <?php echo e(Form::select('state_id', $stateList,'', ['id'=>'statename','class' => 'form-control required','placeholder' => 'Select State'])); ?>
                            ...
                            <div class="security-code-input">
                                ...
                                <div class="security-code-view">
                                    ...
                                    <div class="security-code-img">
                                        <?php echo e(HTML::image("public/img/front/security_code-livetext-nocopy.svg", SITE_TITLE)); ?>
            ...
            <div class="col-xs-12 col-md-4 col-lg-4">
                <div class="checkout-billing-bx">
                    ...
                    <div class="billing-summary">
                        ...
                        <span><i class="fa fa-dollar" aria-hidden="true"></i> <?php echo e(number_format(array_sum($total),2)); ?></span>
                    </div>
                    <div class="billing-summary">
                        <label>Discounts:</label>
                        <span><?php echo e(CURR); ?> <?php echo e(number_format(array_sum($total)-array_sum($subtotal),2)); ?></span>
                    </div>

                    <div class="billing-summary-total">
                        <label>Total:</label>
                        <span><i class="fa fa-dollar" aria-hidden="true"></i> <?php echo e(number_format(array_sum($subtotal),2)); ?></span>
                    </div>
                    <p>Udemy is required by law to collect applicable transaction taxes for purchases made in certain tax jurisdictions.</p>
                    <p>By completing your purchase you agree to these <a target="_black" href="<?php echo e(URL::to( '/terms-and-condition')); ?>">Terms of Service</a>.</p>
            ...
            if (country == '' || state == '') {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result == 1) {
                            window.location = "<?php echo HTTP_PATH; ?>/my-courses";
                        } else {
                            $('#gigdloader').hide();
                            $('#btndivecard').show();
    ...
    function paywithpaypal() {
        var country = $("#country_id").val();
            ...
            if (country == '' || state == '') {
                ...
                window.location = "<?php echo HTTP_PATH; ?>/payments/paywithpaypal";
