...
<div class="teacher-banner">
    <div class="container">
        <div class="banner-text">
            ...
            <a class="btn btn-primary" href="<?php echo e(URL::to('teacher-signup')); ?>">Become an Instructor</a></span>
        ...
        <div class="potential-main-bx">
            <div class="row">
                <div class="col-xs-12 col-md-4 col-lg-4">
                    <div class="card">
                        <div class="potential-icon">
                            <?php echo e(HTML::image('public/img/front/earn-money-icon.png', SITE_TITLE,array('class'=>''))); ?>
                ...
                <div class="col-xs-12 col-md-4 col-lg-4">
                    <div class="card">
                        <div class="potential-icon">
                            <?php echo e(HTML::image('public/img/front/inspire-students-icon.png', SITE_TITLE,array('class'=>''))); ?>
                ...
                <div class="col-xs-12 col-md-4 col-lg-4">
                    <div class="card">
                        <div class="potential-icon">
                            <?php echo e(HTML::image('public/img/front/community-icon.png', SITE_TITLE,array('class'=>''))); ?>
                ...
                <div class="col-xs-12 col-md-12 col-lg-4"> 
                    <div class="expand-card"> 
                        <div class="expand-text"> 
                            <h3><?php echo e($allrecord->client_name); ?></h3>
                            <h5><?php echo e($allrecord->country); ?></h5>
                        </div>
...
<section class="become-section">
    <div class="container">
        ...
        <a href="<?php echo e(URL::to('teacher-signup')); ?>" class="btn btn-primary">Get Started</a>
    </div>
</section>
