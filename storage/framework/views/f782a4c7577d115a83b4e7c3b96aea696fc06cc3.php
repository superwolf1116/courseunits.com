                        ...
                        <?php $__currentLoopData = $allrecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allrecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td data-title="Action">
                                    ...
                                    <a href="<?php echo e(URL::to( 'admin/categories/subsubcategory/'.$catInfo->slug.'/'.$allrecord->slug)); ?>" title="Manage Sub Subcategory" class="btn btn-vimeo btn-xs action-list"><i class="fa fa-sitemap"></i></a>
                                </td>
                            </tr>
