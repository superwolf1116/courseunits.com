...
<?php echo e(HTML::style('public/css/front/sweetalert.min.css')); ?>

<?php echo e(HTML::script('public/js/front/sweetalert.min.js')); ?>
...
<div class="editloader displaynone" id="loaderID"><?php echo e(HTML::image("public/img/website_load.svg", SITE_TITLE)); ?></div>
...
<section class="addcourse-section">
    <div class="container">
        ...
        <?php echo e(Form::model($courseDetail, ['method' => 'post', 'name' => 'editform', 'id' => 'editform', 'enctype' => "multipart/form-data"])); ?> 
        ...
        <div class="step_form_inner step_account1" id="gig_overview">
            ...
            <div class="add-course-bx">
                    ...
                    <div class="add-course-type left_col right_col">
                        ...
                        <div class="course-names">
                            <span class="drop_down_arow" id="subcategory">
                                <?php echo e(Form::select('subcategory_id', $subCatList,null, ['class' => 'form-control required','placeholder' => '-- Select Sub Category --','id'=>'subcategory_id'])); ?>
                    ...
                    <div class="add-course-type left_col">
                        ...
                        <div class="course-names">
                            <span class="drop_down_arow" id="subsubcategory">
                                <?php echo e(Form::select('subsubcategory_id', $subsubCatList,null, ['class' => 'form-control','placeholder' => '-- Select 3 Level Category --'])); ?>
                ...
                <div class="add-course-type">
                    ...
                    <div class="course-names">
                        <?php echo e(Form::textarea('description', null, ['id'=>'description','minlength' => 20, 'maxlength' => 50, 'class'=>'form-control required', 'placeholder'=>"Course Description"])); ?>
                    ...
                    <div class="course-names">
                        <div class="course-video">
                            <div class="create-course-video">
                                ...
                                ?>
                                <?php if(file_exists($filePath) && $courseDetail->image != ''): ?>
                                <?php echo e(HTML::image(COURSE_SMALL_DISPLAY_PATH.$courseDetail->image, SITE_TITLE,['id' => 'ShowImage', 'style'=>"max-width: 100%", 'class' => 'umg_ahe'])); ?>

                                <?php else: ?> 
                                <?php echo e(HTML::image('public/img/front/no_image.png', SITE_TITLE,['id' => 'ShowImage', 'style'=>"max-width: 100%", 'class' => 'umg_ahe'])); ?>
                ...
                <div class="add-course-type">
                    ...
                    <div class="course-names">
                        <div class="create-video edit-video">
                            <div class="video-url">
                                <?php if($courseDetail->sample_video): ?>
                                ...
                                ?>
                                <?php if(file_exists($filePath) && $courseDetail->sample_video != ''): ?>
                                <?php echo e(COURSE_VIDEO_FULL_DISPLAY_PATH.$courseDetail->sample_video); ?>
                ...
                <div class="add-course-type">
                    ...
                    <!--                    <a href="javascript:void(0)" title="Save" onclick="savedata()" class="btn btn-primary
                                                            ">Save</a>-->
                    <?php echo e(Form::submit('Save & Continue', ['class' => 'btn btn-primary', 'id'=>'step_2'])); ?>
        ...
        <div class="step_form_inner second_page step_account2" id="course_content">
            <div class="add-course-type">
                                    ...
                                    <div class="card" id="card_<?php echo $section->id; ?>">
                                        <div class="card-head" id="headingOne">
                                            <h2 class="mb-0" <?php echo $rkey; ?>" <?php echo $rkey; ?>">
                                                ...
                                                <?php echo e(Form::text('section_title[' . $rkey . ']', $section->section_title, ['name'=>'section_title[' . $rkey . '][name]','minlength' => 5, 'class'=>'form-control required', 'placeholder'=>"Section Title", 'autocomplete' => 'off'])); ?>

                                                <?php echo e(Form::hidden('id', $section->id, ['name'=>'section_title[' . $rkey . '][id]', 'class'=>'form-control'])); ?>
                                            ...
                                            <div class="card-body lct_cont_mainn lct_cont_main<?php echo $rkey; ?>"  id="lecturCon<?php echo $rkey; ?>">
                                                ...
                                                <div class="contant-main" id="conetnet_<?php echo $content->id; ?>">
                                                            <div class="course-contant">
                                                                <h3>Lecture Title</h3> 
                                                                <?php echo e(Form::hidden('id', $content->id, ['name'=>'section_title[' . $rkey . '][' . $ckey . '][id]', 'class'=>'form-control'])); ?>

                                                                <p><?php echo e(Form::text('lecture_title[' . $rkey . ']', $content->lecture_title, ['name'=>'section_title[' . $rkey . '][' . $ckey . '][lecture_title]','minlength' => 5, 'class'=>'form-control required', 'placeholder'=>"Lecture Title", 'autocomplete' => 'off'])); ?></p>	   
                                                                <span class="dlt_cont">
                                                            ...
                                                            <div class="lct_cont show"  id="lecturSub<?php echo $rkey . '-' . $ckey; ?>">
                                                                <div class="course-contant course-contant-discriptions">
                                                                    ...
                                                                    <p><?php echo e(Form::textarea('lecture_description[' . $rkey . ']', $content->lecture_description, ['name'=>'section_title[' . $rkey . '][' . $ckey . '][lecture_description]','id'=>'description0','minlength' => 20, 'maxlength' => 50, 'class'=>'form-control required', 'placeholder'=>"Lecture Description"])); ?></p>	   
                                                                </div>
                ...
                ?>
                                                                    ...
                                                                    <?php echo e(Form::file('video[' . $rkey . ']', ['name'=>'section_title[' . $rkey . '][' . $ckey . '][video]','class' => 'videos', 'id' => 'video' . $ckey . '', 'class'=>'form-control','onChange'=>'videoValidation("video' . $ckey . '")'])); ?>
                                ...
                                <div class="card">
                                    <div class="card-head" id="headingOned">
                                        <h2 class="mb-0">
                                            <?php echo e(Form::text('section_title[]', null, ['name'=>'section_title[0][name]','minlength' => 5, 'class'=>'form-control required', 'placeholder'=>"Section Title", 'autocomplete' => 'off'])); ?>
                                    ...
                                    <div id="collapse0" class="collapse show" >
                                        <div class="card-body lct_cont_mainn lct_cont_main0"  id="lecturCon0">
                                            <div class="contant-main ">
                                                <div class="course-contant">
                                                    <h3>Lecture Title</h3> 
                                                    <p><?php echo e(Form::text('lecture_title[0][]', null, ['name'=>'section_title[0][1][lecture_title]','minlength' => 5, 'class'=>'form-control required', 'placeholder'=>"Lecture Title", 'autocomplete' => 'off'])); ?></p>	   
                                                ...
                                                <div class="lct_cont show"  id="lecturSub0">
                                                    <div class="course-contant course-contant-discriptions">
                                                        <h3>Lecture Description</h3>    	
                                                        <p><?php echo e(Form::textarea('lecture_description[0][0]', null, ['name'=>'section_title[0][1][lecture_description]','id'=>'description0','minlength' => 20, 'maxlength' => 50, 'class'=>'form-control required', 'placeholder'=>"Lecture Description"])); ?></p>	   
                                                    </div>
                                                    <div class="course-contant course-contant-video">
                                                        <h3>Lecture Video</h3> 
                                                        <p>													
                                                            <?php echo e(Form::file('video[0][]', ['name'=>'section_title[0][1][video]','class' => 'videos', 'id' => 'video0', 'class'=>'form-control','onChange'=>'videoValidation("video0")'])); ?>
...
<?php } ?>
            ...
            <div class="add-course-type">
                <?php echo e(Form::button('Back', ['class' => 'btn btn-light', 'id'=>'backstep_1'])); ?>

                <!--<a href="javascript:void(0)" title="Save" onclick="savedata()" class="btn btn-default save_btn">Save</a>-->
                <?php echo e(Form::submit('Save & Continue', ['class' => 'btn btn-primary', 'id'=>'step_3'])); ?>
        ...
        <div class="step_form_inner fifth_page step_account3" id="course_publish">
            <div class="congratulation_content">
                ...
                <h4>Before you start selling on <?php echo SITE_TITLE; ?>, please confirm all details. <br>
                    ...
                    <div class="add-course-type">
                        <?php echo e(Form::button('Back', ['class' => 'btn btn-light', 'id'=>'backstep_2'])); ?>

                        <!--<a href="javascript:void(0)" title="Save" onclick="savedata()" class="btn btn-primary">Save</a>-->
                        <?php echo e(Form::submit('Save & Publish', ['class' => 'btn btn-primary', 'id'=>'step_4'])); ?>
