            ...
            <div class="admin_search">
                ...
                <div class="form-group align_box dtpickr_inputs">
                    ...
                    <div class="admin_asearch">
                        ...
                        <div class="ad_cancel"><a href="<?php echo e(URL::to('admin/instructors')); ?>" class="btn btn-default canlcel_le">Clear Search</a></div>
                    </div>
                </div>
                <?php echo e(Form::close()); ?>

                <div class="add_new_record"><a href="<?php echo e(URL::to('admin/instructors/add')); ?>" class="btn btn-default"><i class="fa fa-plus"></i> Add Instructor</a></div>
            </div>            
            <div class="m_content" id="listID">
                <?php echo $__env->make('elements.admin.instructors.index', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
    </section>
</div>
