            ...
            <div class="form-horizontal">
                <div class="box-body">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span class="help-text"> Supported File Types: jpg, jpeg, png (Max. <?php echo e(MAX_IMAGE_UPLOAD_SIZE_DISPLAY); ?>).</span>
                             <?php if($recordInfo->profile_image != ''): ?>
                                ...
                                <div class="help-text"><a href="<?php echo e(URL::to('admin/instructors/deleteimage/'.$recordInfo->slug)); ?>" title="Cancel" class="canlcel_le"  onclick="return confirm('Are you sure you want to delete?')">Delete Image</a></div>
                             <?php endif; ?>
                        </div>
                    </div>                    
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?php echo e(URL::to( 'admin/instructors')); ?>" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>
                    </div>
                </div>
            </div>
