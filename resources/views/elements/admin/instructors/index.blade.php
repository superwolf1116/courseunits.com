...
<div class="panel-body marginzero">
    ...
    <section id="no-more-tables" class="lstng-section">
        <div class="topn">
            <div class="topn_left">Instructors List</div>
        ...
        <div class="tbl-resp-listing">
            <table class="table table-bordered table-striped table-condensed cf">
                <thead class="cf ddpagingshorting">
                    <tr>
                        <th style="width:5%">#</th>
                        <th class="sorting_paging">@sortablelink('first_name', 'Username')</th>
                    ...
                    <tr>
                        ...
                        <td data-title="Action">
                            ...
                            <span class="right_acdc" id="status{{$allrecord->id}}">
                                ...
                                <a href="{{ URL::to( 'admin/instructors/deactivate/'.$allrecord->slug)}}" title="Deactivate" class="deactivate"><button class="btn btn-success btn-xs"><i class="fa fa-check"></i></button></a>
                                @else
                                <a href="{{ URL::to( 'admin/instructors/activate/'.$allrecord->slug)}}" title="Activate" class="activate"><button class="btn btn-danger btn-xs"><i class="fa fa-ban"></i></button></a>
                                @endif
                            </span>
                            <a href="{{ URL::to( 'admin/instructors/edit/'.$allrecord->slug)}}" title="Edit" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                            <a href="{{ URL::to( 'admin/instructors/delete/'.$allrecord->slug)}}" title="Delete" class="btn btn-danger btn-xs action-list delete-list" onclick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash-o"></i></a>
...
<!--                <div class="admin_pop"><span>Gender: </span>  <label>{!! $allrecord->gender !!}</label></div>-->
                ...
                <div class="admin_pop"><span>Profile Image</span> <label><i class="users--img">{{HTML::image(PROFILE_SMALL_DISPLAY_PATH.$allrecord->profile_image, SITE_TITLE,['style'=>""])}}</i></label></div>
                @endif
        </fieldset>
    </div>
</div>
