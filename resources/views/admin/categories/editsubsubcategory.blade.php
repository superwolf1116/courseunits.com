...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::to('admin/categories/subcategory/'.$maincatInfo->slug)}}"><i class="fa fa-sitemap"></i> <span>{!! $maincatInfo->name !!}</span></a></li>
            <li><a href="{{URL::to('admin/categories/subsubcategory/'.$maincatInfo->slug.'/'.$catInfo->slug)}}"><i class="fa fa-sitemap"></i> <span>{!! $catInfo->name !!}</span></a></li>
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ URL::to( 'admin/categories/subsubcategory/'.$maincatInfo->slug.'/'.$catInfo->slug)}}" title="Cancel" class="btn btn-default canlcel_le">Cancel</a>
                    </div>
                </div>
            </div>
            {{ Form::close()}}
