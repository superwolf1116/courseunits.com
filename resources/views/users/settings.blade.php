                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                        <div class="ch_paypalemail">
                            ...
                            {{Form::model($recordInfo, ['method' => 'post', 'name' => 'changeemail', 'id' => 'changeemail', 'enctype' => "multipart/form-data"]) }} 
                            <div class="setting-input">
                                <div class="form-group">
                                    {{Form::text('first_name', $recordInfo->first_name, ['class'=>'form-control required', 'placeholder'=>'First Name', 'autocomplete' => 'off', 'id'=>'first_name'])}}
                                </div>
                            </div>
                            <div class="setting-input">
                                <div class="form-group">
                                    {{Form::text('last_name', $recordInfo->last_name, ['class'=>'form-control required', 'placeholder'=>'Last Name', 'autocomplete' => 'off', 'id'=>'last_name'])}}
                                </div>
                            </div>
                            <div class="setting-input">
                                <div class="form-group">
                                    {{Form::text('contact', $recordInfo->contact, ['class'=>'form-control required', 'placeholder'=>'Contact Number', 'autocomplete' => 'off', 'id'=>'contact','maxlenght'=>'15'])}}
                                </div>
                            </div>
                            <div class="setting-input">
                                <div class="form-group">
                                    {{Form::text('about_short', $recordInfo->about_short, ['class'=>'form-control required', 'placeholder'=>'Short Bio', 'autocomplete' => 'off'])}}
                                </div>
                            </div>
                            ...
                            <div class="setting-input">
                                <div class="form-group">
                                    {{Form::textarea('about', null, ['id'=>'about','minlength' => 120, 'maxlength' => 1200, 'class'=>'form-control required', 'placeholder'=>"About Me"])}}
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <div class="setting-btn">
                                    {{Form::submit('Save Changes', ['class' => 'succbtn', 'id'=>'emailbtn'])}}
